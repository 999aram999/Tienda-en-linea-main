@extends('layouts.web')
@section('meta_description','Tienda en línea')
                            ...
                            <div class="order-payment-method">
                                ...
                                <div class="single-payment-method">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="{{$paymentPlatform->name}}payment" name="payment_platform" value="{{$paymentPlatform->id}}" class="custom-control-input" />
                                    ...
                                    <div class="payment-method-details" data-method="{{$paymentPlatform->id}}">
                                        <p>Pay via PayPal; you can with your credit card if you don’t have a PayPal account.</p>
                                    </div>
                                </div>
                                @endforeach
                                ...
                                {{-- <div class="single-payment-method">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="{{$key}}" name="payment_platform" value="{{$paymentPlatform->id}}" class="custom-control-input" required/>
                                            <label class="custom-control-label" for="{{$key}}">{{$paymentPlatform->name}} <img src="{{$paymentPlatform->image}}" class="img-fluid paypal-card" alt="Paypal" /></label>
                                        </div>
                                    </div>
                                    <div class="payment-method-details" data-method="{{$paymentPlatform->id}}">
                                        <p>Pay via PayPal</p>
                                ...
                                <div class="single-payment-method">
                                    ...
                                    ">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <input type="radio" id="{{$key}}" name="payment_platform" value="{{$paymentPlatform->id}}" class="custom-control-input" @if ($loop->first)
                                            checked
                                            @endif
                                            required />
                                            <label class="custom-control-label" for="{{$key}}">{{$paymentPlatform->name}} <img src="{{$paymentPlatform->image}}" class="img-fluid paypal-card" alt="Paypal" /></label>
                                ...
                                <div class="summary-footer-area">
                                    ...
                                    <button type="submit" class="check-btn sqr-btn" id="payButton">Place Order</button>
                                </div>
                            </div>
                        </form>
                    </div>
