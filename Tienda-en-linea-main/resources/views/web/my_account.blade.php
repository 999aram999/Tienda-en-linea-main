                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="{{Route('web.account_info')}}" class="{!! active_class(route('web.account_info')) !!}"><i class="fa fa-user"></i> Detalles de mi cuenta</a>
                                <a class="{!! active_class(route('web.change_password')) !!}" href="{{route('web.change_password')}}"><i class="fa fa-credit-card"></i>Cambiar contraseña</a>
